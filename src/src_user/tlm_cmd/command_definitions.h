...
typedef enum
{
  ...
  Cmd_CODE_CSRV_STIM377H_INIT = 0x005F,
  Cmd_CODE_CSRV_STIM377H_SET_MODE = 0x0060,
  Cmd_CODE_CSRV_STIM377H_SET_NORMAL_MODE_FORMAT = 0x0061,
  Cmd_CODE_CSRV_STIM377H_SET_GYRO_OUTPUT = 0x0062,
  Cmd_CODE_CSRV_STIM377H_SET_SAMPLE_RATE = 0x0063,
  Cmd_CODE_CSRV_STIM377H_SET_TERMINATION_MODE = 0x0064,
  Cmd_CODE_CSRV_STIM377H_SET_LOW_PASS_FILTER = 0x0065,
  Cmd_CODE_CSRV_STIM377H_SET_FRAME_TRANSFORMATION_QUATERNION_C2B = 0x0066,
  Cmd_CODE_CSRV_STIM377H_SET_ANG_VEL_BIAS_COMPO_RAD_S = 0x0067,
  Cmd_CODE_CSRV_STIM377H_SET_ANG_VEL_BIAS_TEMP_CALIB = 0x0068,
  Cmd_CODE_CSRV_STIM377H_SET_ANG_VEL_SF_TEMP_CALIB = 0x0069,
